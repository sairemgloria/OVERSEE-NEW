...
$sql = "SELECT employees.*, attendance.EMP_NAME, attendance.AMLOGIN, attendance.AMLOGIN_STATUS, attendance.PMLOGOUT, attendance.PMLOGOUT_STATUS, CURRENTDATE, STATUS FROM employees INNER JOIN attendance ON attendance.EMP_NAME = CONCAT(employees.FNAME, ' ', employees.MI, ' ', employees.LNAME) WHERE employees.ID = '" . $userAcc['ID'] . "'";
