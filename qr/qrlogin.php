...
<head>
  ...
  <!-- external CSS -->
  <link rel="stylesheet" href="assets/css/qrlogin.css" type="text/css">
  <!-- logo -->
  <link rel="icon" type="image/x-icon" href="assets/images/logo.png">
  <title>OverSEE | QR Scanner</title>
</head>
  ...
  <div class="container-fluid p-0">
    <div class="row" id="content">
      <div class="col-md-5 d-md-block d-none bg-none p-0">
        <div class="display-image" style="background: linear-gradient(rgba(242, 192, 135, 0.55), rgba(168, 78, 51, 0.75)), url('assets/images/mrwsdpQr.jpg'); height: 100%; width: 100%; background-size: contain, cover; background-position: center; background-repeat: no-repeat;">
        </div>
      </div>
      <div class="col-md-7 bg-white text-black">
        <div class="mycontent">
          <h2><span class="dashboard-span fw-bold">|</span> QR <span>Scanner</span></h2>
          <h5 class="oversee-h5">Sign in to proceed QR Scanner</h5>
          ...
          <form action="check_login.php" method="POST" autocomplete="off">
            <div class="mb-3">
              ...
              <input type="text" name="USERNAME" class="form-control" placeholder="eg. qrscan">
            </div>
            <div class="mb-5">
