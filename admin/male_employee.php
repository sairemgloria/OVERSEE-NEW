...
<div id="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h1 class="my-0 my-md-3 my-lg-3 fw-bold"><span class="dashboard-span fw-bold">|</span> Male Employee Records</h1>
            </div>
            <div class="col-sm-6" id="breadcrumb-align-center">
                <ol class="breadcrumb float-sm-right my-0 my-md-3 my-lg-3">
                    <li class="breadcrumb-item"><a href="dashboard.php" style="text-decoration: none;">Home</a></li>
                    <li class="breadcrumb-item active">Male Employee Records</li>
                </ol>
            </div>
        </div>
        <!-- added breadcrumb features -->
        ...
        <div class="table-responsive">
            <table id="employeeTable" class="display table table-responsive">
                ...
                <tbody>
                    <?php include("includes/display_all_male_employee.php"); ?>
                </tbody>
                <tfoot>
                    <tr>
                        <th style="text-align: center; vertical-align: middle;">#</th>
